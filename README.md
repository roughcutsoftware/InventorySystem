...
### Dashboard
![Dashboard View](wwwroot/assets/screenshots/dashboard.png)
- Real-time statistics
- Stock alerts
- Recent activities

### Products
![Product Management](wwwroot/assets/screenshots/products.png)
- Product listing
- Stock levels
- Quick actions

### Sales
![Sales Management](wwwroot/assets/screenshots/sales.png)
- Sales creation
- Customer selection
- Product selection
